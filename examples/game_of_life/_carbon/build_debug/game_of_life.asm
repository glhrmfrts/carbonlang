...
cb__Nmain__Nget__Aptr__TU_Field2D__Aint__Aint$end:
 add rsp,8
 pop rbx
 pop rbp
 ret
...
cb__Nmain__Nclear__Aptr__TU_Field2D:
 ...
 mov r10d,dword [rdi+0]
 imul r10d,dword [rax+4]
 mov eax,r10d
 ;ir_mul [ST . 0] [ST . 1];
...
cb__Nmain__Nprint__Aptr__TU_Automaton$end:
 add rsp,96
 pop rdi
 pop rbx
 pop rbp
...
cb__Nmain__Nmain__Aptr__Tslice__TU_string$f878$body:
 ...
 mov rcx,rax
 call cb__Nmain__Nprint__Aptr__TU_Automaton
