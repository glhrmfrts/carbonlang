...
section .data
$cbstr0: db 0
$cbstr1: db 91,79,75,93,32,116,101,115,116,95,116,117,112,108,101,95,122,101,114,111,105,110,105,116,0
$cbstr2: db 91,78,79,75,93,32,116,101,115,116,95,116,117,112,108,101,95,122,101,114,111,105,110,105,116,0
section .code
cb__Nmain__Nmain__Aref__Tslice__TU_String:
 ...
 cmp al,0
 je cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$else
 ;ir_jmp_eq ST 0 cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$else;

 mov r10b,byte [rbp-16]
 cmp r10b,0
 jne cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$else
 ;ir_jmp_neq [L1 . 1] 0 cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$else;

cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$body:
 ;ir_make_label cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$body;
 ...
 jmp cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$end
 ;ir_jmp cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$end;

cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$else:
 ;ir_make_label cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$else;
...
cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$end:
 ;ir_make_label cb__Nmain__Nmain__Aref__Tslice__TU_String$if64$end;
...
cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$cond:
 ;ir_make_label cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$cond;
 ...
 cmp eax,0
 je cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$end
 ;ir_jmp_eq ST 0 cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$end;

cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$body;
 ...
 jmp cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$cond
 ;ir_jmp cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$cond;

cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$end:
 ;ir_make_label cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w637$end;
...
cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar:
 ...
 cmp rbx,rax
 je cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if669$else
 ;ir_jmp_eq ST ST cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if669$else;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if669$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if669$body;

 mov al,0
 jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$end
 ;ir_return 0;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if669$else:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if669$else;
...
cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$cond:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$cond;

 movsxd rax,dword [rbp-24]
 ;ir_cast L2;

 cmp rax,qword [rbp-12]
 jge cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$end
 ;ir_jmp_gte ST [L0 . 1] cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$end;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$body;
 ...
 mov r10b,byte [rbx+0]
 cmp r10b,byte [rax+0]
 je cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if690$else
 ;ir_jmp_eq ST ST cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if690$else;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if690$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if690$body;

 mov al,0
 jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$end
 ;ir_return 0;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if690$else:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if690$else;
 ...
 jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$cond
 ;ir_jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$cond;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$end:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f693$end;
