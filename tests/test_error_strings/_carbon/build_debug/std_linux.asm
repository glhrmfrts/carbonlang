...
.f405$cond:
# ir_make_label .f405$cond;

 mov -48(%rbp),%r10d
 cmp -40(%rbp),%r10d
 jge .f405$neg
# ir_jmp_gte [L2 . 0] [L2 . 1] .f405$neg;
...
# ir_load L5 1;
 ...
 cmp -40(%rbp),%r10d
 jge .f405$end
# ir_jmp_gte L1 [L2 . 1] .f405$end;

 jmp .f405$body
# ir_jmp .f405$body;

.f405$neg:
# ir_make_label .f405$neg;
...
# ir_load L5 -1;
 ...
 cmp -40(%rbp),%r10d
 jle .f405$end
# ir_jmp_lte L1 [L2 . 1] .f405$end;

.f405$body:
# ir_make_label .f405$body;
...
# prolog end
 ...
 cmp $0,%r10d
 jne .if435$else
# ir_jmp_neq A1 0 .if435$else;

.if435$body:
# ir_make_label .if435$body;
...
.w538$cond:
# ir_make_label .w538$cond;

 mov -24(%rbp),%r10
 cmp -16(%rbp),%r10
 jge .w538$end
# ir_jmp_gte L2 L1 .w538$end;

.w538$body:
# ir_make_label .w538$body;
...
# ir_deref L5; (push)
 ...
 cmp 0(%rax),%r10d
 jne .if521$else
# ir_jmp_neq L3 POP() .if521$else;

.if521$body:
# ir_make_label .if521$body;
...
# ir_cast POP(); (push)
 ...
 cmp %rax,%r10
 jne .if864$else
# ir_jmp_neq L1 POP() .if864$else;

.if864$body:
# ir_make_label .if864$body;
...
# ir_and A0 POP(); (push)
 ...
 cmp $0,%eax
 je .if1068$else
# ir_jmp_eq POP() 0 .if1068$else;

.if1068$body:
# ir_make_label .if1068$body;
...
# ir_and A0 1; (push)
 ...
 cmp $0,%eax
 je .if1067$else
# ir_jmp_eq POP() 0 .if1067$else;

.if1067$body:
# ir_make_label .if1067$body;
...
# ir_and A0 2; (push)
 ...
 cmp $0,%eax
 je .if1066$else
# ir_jmp_eq POP() 0 .if1066$else;

.if1066$body:
# ir_make_label .if1066$body;
...
.if1066$else:
# ir_make_label .if1066$else;

.if1067$end:
# ir_make_label .if1067$end;

.if1068$end:
# ir_make_label .if1068$end;
...
# ir_and A0 4; (push)
 ...
 cmp $0,%eax
 je .if1078$else
# ir_jmp_eq POP() 0 .if1078$else;

.if1078$body:
# ir_make_label .if1078$body;
...
# ir_and A0 8; (push)
 ...
 cmp $0,%eax
 je .if1088$else
# ir_jmp_eq POP() 0 .if1088$else;

.if1088$body:
# ir_make_label .if1088$body;
...
# ir_and A0 16; (push)
 ...
 cmp $0,%eax
 je .if1098$else
# ir_jmp_eq POP() 0 .if1098$else;

.if1098$body:
# ir_make_label .if1098$body;
...
# ir_load L0 POP();
 ...
 cmp $0,%r10d
 jne .if1376$else
# ir_jmp_neq L0 0 .if1376$else;

.if1376$body:
# ir_make_label .if1376$body;
...
.f1280$cond:
# ir_make_label .f1280$cond;

 mov -96(%rbp),%r10d
 cmp -88(%rbp),%r10d
 jge .f1280$neg
# ir_jmp_gte [L5 . 0] [L5 . 1] .f1280$neg;
...
# ir_load L7 1;
 ...
 cmp -88(%rbp),%r10d
 jge .f1280$end
# ir_jmp_gte L4 [L5 . 1] .f1280$end;

 jmp .f1280$body
# ir_jmp .f1280$body;

.f1280$neg:
# ir_make_label .f1280$neg;
...
# ir_load L7 -1;
 ...
 cmp -88(%rbp),%r10d
 jle .f1280$end
# ir_jmp_lte L4 [L5 . 1] .f1280$end;

.f1280$body:
# ir_make_label .f1280$body;
...
# ir_neg 1; (push)
 ...
 cmp %eax,%r10d
 je .if1375$else
# ir_jmp_eq L0 POP() .if1375$else;

.if1375$body:
# ir_make_label .if1375$body;
...
# ir_call cb__Nstd__Nsystem__Nwifexited__Aint L6; (push)
 ...
 cmp $0,%al
 je .if1357$else
# ir_jmp_eq POP() 0 .if1357$else;

.if1357$body:
# ir_make_label .if1357$body;
...
# ir_call cb__Nstd__Nsystem__Nwifsignaled__Aint L6; (push)
 ...
 cmp $0,%al
 je .if1356$else
# ir_jmp_eq POP() 0 .if1356$else;

.if1356$body:
# ir_make_label .if1356$body;
...
.if1356$else:
# ir_make_label .if1356$else;

.if1357$end:
# ir_make_label .if1357$end;
...
.if1375$end:
# ir_make_label .if1375$end;

.if1376$end:
# ir_make_label .if1376$end;
...
# ir_load L2 [L0 . 1];
 ...
 cmp $0,%r10d
 je .if1514$else
# ir_jmp_eq L2 0 .if1514$else;

.if1514$body:
# ir_make_label .if1514$body;
...
# ir_load L5 [L3 . 1];
 ...
 cmp $0,%r10d
 je .if1577$else
# ir_jmp_eq L5 0 .if1577$else;

.if1577$body:
# ir_make_label .if1577$body;
...
.f1668$cond:
# ir_make_label .f1668$cond;

 mov -156(%rbp),%r10d
 cmp -152(%rbp),%r10d
 jge .f1668$neg
# ir_jmp_gte [L11 . 0] [L11 . 1] .f1668$neg;
...
# ir_load L15 1;
 ...
 cmp -152(%rbp),%r10d
 jge .f1668$end
# ir_jmp_gte L10 [L11 . 1] .f1668$end;

 jmp .f1668$body
# ir_jmp .f1668$body;

.f1668$neg:
# ir_make_label .f1668$neg;
...
# ir_load L15 -1;
 ...
 cmp -152(%rbp),%r10d
 jle .f1668$end
# ir_jmp_lte L10 [L11 . 1] .f1668$end;

.f1668$body:
# ir_make_label .f1668$body;
...
.f1695$cond:
# ir_make_label .f1695$cond;

 mov -168(%rbp),%r10d
 cmp -164(%rbp),%r10d
 jge .f1695$neg
# ir_jmp_gte [L13 . 0] [L13 . 1] .f1695$neg;
...
# ir_load L16 1;
 ...
 cmp -164(%rbp),%r10d
 jge .f1695$end
# ir_jmp_gte L12 [L13 . 1] .f1695$end;

 jmp .f1695$body
# ir_jmp .f1695$body;

.f1695$neg:
# ir_make_label .f1695$neg;
...
# ir_load L16 -1;
 ...
 cmp -164(%rbp),%r10d
 jle .f1695$end
# ir_jmp_lte L12 [L13 . 1] .f1695$end;

.f1695$body:
# ir_make_label .f1695$body;
...
# ir_call cb__Nstd__Nlinux__Nsyscall__Nstat__Aptr__Tpure__Tuint8__Aptr__Topaque [POP() . 0] POP(); (push)
 ...
 cmp $0,%eax
 jge .if1918$else
# ir_jmp_gte POP() 0 .if1918$else;

.if1918$body:
# ir_make_label .if1918$body;
...
# ir_call cb__Nstd__Nlinux__Nsyscall__Nfstat__Aint__Aptr__Topaque POP() POP(); (push)
 ...
 cmp $0,%eax
 jge .if1972$else
# ir_jmp_gte POP() 0 .if1972$else;

.if1972$body:
# ir_make_label .if1972$body;
