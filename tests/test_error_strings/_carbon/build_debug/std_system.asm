...
# prolog end
 ...
 cmp $2,%r10d
 jl .if3837$body
# ir_jmp_lt A1 2 .if3837$body;

 mov 40(%rbp),%r10d
 cmp $36,%r10d
 jle .if3837$else
# ir_jmp_lte A1 36 .if3837$else;

.if3837$body:
# ir_make_label .if3837$body;
...
# ir_cast L2; (push)
 ...
 cmp -8(%rbp),%rax
 jl .if3878$else
# ir_jmp_lt POP() [L0 . 1] .if3878$else;
