...
section .data
$cbstr0: db 91,79,75,93,32,116,101,115,116,95,99,97,108,108,95,115,117,103,97,114,0
$cbstr1: db 91,78,79,75,93,32,116,101,115,116,95,99,97,108,108,95,115,117,103,97,114,0
section .code
...
cb__Nmain__Nmain__Aref__Tslice__TU_String:
 ...
 mov ecx,5
 call cb__Nmain__Nsquare__Aint
 ;ir_call cb__Nmain__Nsquare__Aint 5;

 mov ecx,eax
 call cb__Nmain__Nsquare__Aint
 ;ir_call cb__Nmain__Nsquare__Aint ST;
 ...
 cmp r10d,eax
 jne cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$else
 ;ir_jmp_neq L0 ST cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$else;

cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$body:
 ;ir_make_label cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$body;
 ...
 jmp cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$end
 ;ir_jmp cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$end;

cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$else:
 ;ir_make_label cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$else;
...
cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$end:
 ;ir_make_label cb__Nmain__Nmain__Aref__Tslice__TU_String$if76$end;
...
cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$cond:
 ;ir_make_label cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$cond;
 ...
 cmp eax,0
 je cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$end
 ;ir_jmp_eq ST 0 cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$end;

cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$body;
 ...
 jmp cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$cond
 ;ir_jmp cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$cond;

cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$end:
 ;ir_make_label cb__Nstd__Nrawstring__Nstrlen__Aptr__Tchar$w621$end;
...
cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar:
 ...
 cmp rdi,rax
 je cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if653$else
 ;ir_jmp_eq ST ST cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if653$else;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if653$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if653$body;

 mov al,0
 jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$end
 ;ir_return 0;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if653$else:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if653$else;
...
cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$cond:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$cond;

 movsxd rax,dword [rbp-24]
 ;ir_cast L2;

 cmp rax,qword [rbp-12]
 jge cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$end
 ;ir_jmp_gte ST [L0 . 1] cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$end;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$body;
 ...
 mov r10b,byte [rdi+0]
 cmp r10b,byte [rax+0]
 je cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if674$else
 ;ir_jmp_eq ST ST cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if674$else;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if674$body:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if674$body;

 mov al,0
 jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$end
 ;ir_return 0;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if674$else:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$if674$else;
 ...
 jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$cond
 ;ir_jmp cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$cond;

cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$end:
 ;ir_make_label cb__Nstd__Nrawstring__Nequals__Aptr__Tchar__Aptr__Tchar$f677$end;
