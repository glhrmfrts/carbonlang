...
.w2697$cond:
# ir_make_label .w2697$cond;

 mov -16(%rbp),%r10
 cmp $0,%r10
 je .w2697$end
# ir_jmp_eq L1 0 .w2697$end;

.w2697$body:
# ir_make_label .w2697$body;
...
# ir_deref L1; (push)
 ...
 cmp 8(%rax),%rbx
 jge .if2688$else
# ir_jmp_gte POP() [POP() . 1] .if2688$else;

.if2688$body:
# ir_make_label .if2688$body;

 jmp .w2697$end
# ir_jmp .w2697$end;

.if2688$else:
# ir_make_label .if2688$else;
...
.w2697$end:
# ir_make_label .w2697$end;

 mov -16(%rbp),%r10
 cmp $0,%r10
 je .if2713$else
# ir_jmp_eq L1 0 .if2713$else;

.if2713$body:
# ir_make_label .if2713$body;
...
# ir_load L6 [L4 . 1];
 ...
 cmp $0,%r10d
 je .if2747$else
# ir_jmp_eq L6 0 .if2747$else;

.if2747$body:
# ir_make_label .if2747$body;
...
.w2864$cond:
# ir_make_label .w2864$cond;

 mov -8(%rbp),%r10
 cmp $0,%r10
 je .w2864$end
# ir_jmp_eq L0 0 .w2864$end;

.w2864$body:
# ir_make_label .w2864$body;
...
# ir_add L2 [POP() . 1]; (push)
 ...
 cmp %rax,%r10
 jge .if2851$else
# ir_jmp_gte A0 POP() .if2851$else;

.if2851$body:
# ir_make_label .if2851$body;

 jmp .w2864$end
# ir_jmp .w2864$end;

.if2851$else:
# ir_make_label .if2851$else;
...
.w2864$end:
# ir_make_label .w2864$end;

 mov -8(%rbp),%r10
 cmp $0,%r10
 jne .if2872$else
# ir_jmp_neq L0 0 .if2872$else;

.if2872$body:
# ir_make_label .if2872$body;

 jmp .cb__Nstd__Nmem__Nfree__Aptr__Topaque$end
# ir_return #0;

.if2872$else:
# ir_make_label .if2872$else;
...
# ir_deref L0; (push)
 ...
 cmp $0,%r10
 jne .if2915$else
# ir_jmp_neq [POP() . 2] 0 .if2915$else;

.if2915$body:
# ir_make_label .if2915$body;

 mov std__mem__last_block(%rip),%r10
 cmp -8(%rbp),%r10
 jne .if2904$else
# ir_jmp_neq  L0 .if2904$else;

.if2904$body:
# ir_make_label .if2904$body;
...
# ir_load L3 [L1 . 1];
 ...
 cmp $0,%r10d
 je .if4180$else
# ir_jmp_eq L3 0 .if4180$else;

.if4180$body:
# ir_make_label .if4180$body;
