...
# prolog end
 ...
 cmp $2,%r10d
 jl .if3873$body
# ir_jmp_lt A1 2 .if3873$body;

 mov 40(%rbp),%r10d
 cmp $36,%r10d
 jle .if3873$else
# ir_jmp_lte A1 36 .if3873$else;

.if3873$body:
# ir_make_label .if3873$body;
...
.w3949$cond:
# ir_make_label .w3949$cond;

 mov -28(%rbp),%r10d
 cmp $0,%r10d
 je .w3949$end
# ir_jmp_eq L3 0 .w3949$end;

.w3949$body:
# ir_make_label .w3949$body;
...
# ir_cast L2; (push)
 ...
 cmp -8(%rbp),%rax
 jl .if3914$else
# ir_jmp_lt POP() [L0 . 1] .if3914$else;

.if3914$body:
# ir_make_label .if3914$body;
...
# ir_load L5 POP();
 ...
 cmp $0,%r10d
 jge .if3989$else
# ir_jmp_gte L1 0 .if3989$else;

.if3989$body:
# ir_make_label .if3989$body;
...
.w4035$cond:
# ir_make_label .w4035$cond;

 mov -48(%rbp),%r10
 cmp -40(%rbp),%r10
 jge .w4035$end
# ir_jmp_gte L5 L4 .w4035$end;

.w4035$body:
# ir_make_label .w4035$body;
