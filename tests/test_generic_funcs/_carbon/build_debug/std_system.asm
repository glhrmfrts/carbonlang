...
# prolog end
 ...
 cmp $2,%r10d
 jl .if4132$body
# ir_jmp_lt A1 2 .if4132$body;

 mov 40(%rbp),%r10d
 cmp $36,%r10d
 jle .if4132$else
# ir_jmp_lte A1 36 .if4132$else;

.if4132$body:
# ir_make_label .if4132$body;
...
.w4208$cond:
# ir_make_label .w4208$cond;

 mov -28(%rbp),%r10d
 cmp $0,%r10d
 je .w4208$end
# ir_jmp_eq L3 0 .w4208$end;

.w4208$body:
# ir_make_label .w4208$body;
...
# ir_cast L2; (push)
 ...
 cmp -8(%rbp),%rax
 jl .if4173$else
# ir_jmp_lt POP() [L0 . 1] .if4173$else;

.if4173$body:
# ir_make_label .if4173$body;
...
# ir_load L5 POP();
 ...
 cmp $0,%r10d
 jge .if4248$else
# ir_jmp_gte L1 0 .if4248$else;

.if4248$body:
# ir_make_label .if4248$body;
...
.w4294$cond:
# ir_make_label .w4294$cond;

 mov -48(%rbp),%r10
 cmp -40(%rbp),%r10
 jge .w4294$end
# ir_jmp_gte L5 L4 .w4294$end;

.w4294$body:
# ir_make_label .w4294$body;
