...
.w2956$cond:
# ir_make_label .w2956$cond;

 mov -16(%rbp),%r10
 cmp $0,%r10
 je .w2956$end
# ir_jmp_eq L1 0 .w2956$end;

.w2956$body:
# ir_make_label .w2956$body;
...
# ir_deref L1; (push)
 ...
 cmp 8(%rax),%rbx
 jge .if2947$else
# ir_jmp_gte POP() [POP() . 1] .if2947$else;

.if2947$body:
# ir_make_label .if2947$body;

 jmp .w2956$end
# ir_jmp .w2956$end;

.if2947$else:
# ir_make_label .if2947$else;
...
.w2956$end:
# ir_make_label .w2956$end;

 mov -16(%rbp),%r10
 cmp $0,%r10
 je .if2972$else
# ir_jmp_eq L1 0 .if2972$else;

.if2972$body:
# ir_make_label .if2972$body;
...
# ir_load L6 [L4 . 1];
 ...
 cmp $0,%r10d
 je .if3006$else
# ir_jmp_eq L6 0 .if3006$else;

.if3006$body:
# ir_make_label .if3006$body;
...
.w3123$cond:
# ir_make_label .w3123$cond;

 mov -8(%rbp),%r10
 cmp $0,%r10
 je .w3123$end
# ir_jmp_eq L0 0 .w3123$end;

.w3123$body:
# ir_make_label .w3123$body;
...
# ir_add L2 [POP() . 1]; (push)
 ...
 cmp %rax,%r10
 jge .if3110$else
# ir_jmp_gte A0 POP() .if3110$else;

.if3110$body:
# ir_make_label .if3110$body;

 jmp .w3123$end
# ir_jmp .w3123$end;

.if3110$else:
# ir_make_label .if3110$else;
...
.w3123$end:
# ir_make_label .w3123$end;

 mov -8(%rbp),%r10
 cmp $0,%r10
 jne .if3131$else
# ir_jmp_neq L0 0 .if3131$else;

.if3131$body:
# ir_make_label .if3131$body;

 jmp .cb__Nstd__Nmem__Nfree__Aptr__Topaque$end
# ir_return #0;

.if3131$else:
# ir_make_label .if3131$else;
...
# ir_deref L0; (push)
 ...
 cmp $0,%r10
 jne .if3174$else
# ir_jmp_neq [POP() . 2] 0 .if3174$else;

.if3174$body:
# ir_make_label .if3174$body;

 mov std__mem__last_block(%rip),%r10
 cmp -8(%rbp),%r10
 jne .if3163$else
# ir_jmp_neq  L0 .if3163$else;

.if3163$body:
# ir_make_label .if3163$body;
...
# ir_load L3 [L1 . 1];
 ...
 cmp $0,%r10d
 je .if4439$else
# ir_jmp_eq L3 0 .if4439$else;

.if4439$body:
# ir_make_label .if4439$body;
