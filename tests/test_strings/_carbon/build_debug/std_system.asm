...
# prolog end
 ...
 cmp $2,%r10d
 jl .if4002$body
# ir_jmp_lt A1 2 .if4002$body;

 mov 40(%rbp),%r10d
 cmp $36,%r10d
 jle .if4002$else
# ir_jmp_lte A1 36 .if4002$else;

.if4002$body:
# ir_make_label .if4002$body;
...
.w4078$cond:
# ir_make_label .w4078$cond;

 mov -44(%rbp),%r10d
 cmp $0,%r10d
 je .w4078$end
# ir_jmp_eq L4 0 .w4078$end;

.w4078$body:
# ir_make_label .w4078$body;
...
# ir_cast L3; (push)
 ...
 cmp -8(%rbp),%rax
 jl .if4043$else
# ir_jmp_lt POP() [L0 . 1] .if4043$else;

.if4043$body:
# ir_make_label .if4043$body;
...
# ir_load L6 POP();
 ...
 cmp $0,%r10d
 jge .if4118$else
# ir_jmp_gte L2 0 .if4118$else;

.if4118$body:
# ir_make_label .if4118$body;
...
.w4164$cond:
# ir_make_label .w4164$cond;

 mov -64(%rbp),%r10
 cmp -56(%rbp),%r10
 jge .w4164$end
# ir_jmp_gte L6 L5 .w4164$end;

.w4164$body:
# ir_make_label .w4164$body;
