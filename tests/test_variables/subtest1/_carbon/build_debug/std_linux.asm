...
.f389$cond:
# ir_make_label .f389$cond;

 mov -48(%rbp),%r10d
 cmp -40(%rbp),%r10d
 jge .f389$neg
# ir_jmp_gte [L2 . 0] [L2 . 1] .f389$neg;
...
# ir_load L5 1;
 ...
 cmp -40(%rbp),%r10d
 jge .f389$end
# ir_jmp_gte L1 [L2 . 1] .f389$end;

 jmp .f389$body
# ir_jmp .f389$body;

.f389$neg:
# ir_make_label .f389$neg;
...
# ir_load L5 -1;
 ...
 cmp -40(%rbp),%r10d
 jle .f389$end
# ir_jmp_lte L1 [L2 . 1] .f389$end;

.f389$body:
# ir_make_label .f389$body;
...
# prolog end
 ...
 cmp $0,%r10d
 jne .if419$else
# ir_jmp_neq A1 0 .if419$else;

.if419$body:
# ir_make_label .if419$body;
...
.w522$cond:
# ir_make_label .w522$cond;

 mov -24(%rbp),%r10
 cmp -16(%rbp),%r10
 jge .w522$end
# ir_jmp_gte L2 L1 .w522$end;

.w522$body:
# ir_make_label .w522$body;
...
# ir_deref L5; (push)
 ...
 cmp 0(%rax),%r10d
 jne .if505$else
# ir_jmp_neq L3 POP() .if505$else;

.if505$body:
# ir_make_label .if505$body;
...
# ir_cast POP(); (push)
 ...
 cmp %rax,%r10
 jne .if848$else
# ir_jmp_neq L1 POP() .if848$else;

.if848$body:
# ir_make_label .if848$body;
...
# ir_and A0 POP(); (push)
 ...
 cmp $0,%eax
 je .if1052$else
# ir_jmp_eq POP() 0 .if1052$else;

.if1052$body:
# ir_make_label .if1052$body;
...
# ir_and A0 1; (push)
 ...
 cmp $0,%eax
 je .if1051$else
# ir_jmp_eq POP() 0 .if1051$else;

.if1051$body:
# ir_make_label .if1051$body;
...
# ir_and A0 2; (push)
 ...
 cmp $0,%eax
 je .if1050$else
# ir_jmp_eq POP() 0 .if1050$else;

.if1050$body:
# ir_make_label .if1050$body;
...
.if1050$else:
# ir_make_label .if1050$else;

.if1051$end:
# ir_make_label .if1051$end;

.if1052$end:
# ir_make_label .if1052$end;
...
# ir_and A0 4; (push)
 ...
 cmp $0,%eax
 je .if1062$else
# ir_jmp_eq POP() 0 .if1062$else;

.if1062$body:
# ir_make_label .if1062$body;
...
# ir_and A0 8; (push)
 ...
 cmp $0,%eax
 je .if1072$else
# ir_jmp_eq POP() 0 .if1072$else;

.if1072$body:
# ir_make_label .if1072$body;
...
# ir_and A0 16; (push)
 ...
 cmp $0,%eax
 je .if1082$else
# ir_jmp_eq POP() 0 .if1082$else;

.if1082$body:
# ir_make_label .if1082$body;
...
# ir_load L0 POP();
 ...
 cmp $0,%r10d
 jne .if1360$else
# ir_jmp_neq L0 0 .if1360$else;

.if1360$body:
# ir_make_label .if1360$body;
...
.f1264$cond:
# ir_make_label .f1264$cond;

 mov -96(%rbp),%r10d
 cmp -88(%rbp),%r10d
 jge .f1264$neg
# ir_jmp_gte [L5 . 0] [L5 . 1] .f1264$neg;
...
# ir_load L7 1;
 ...
 cmp -88(%rbp),%r10d
 jge .f1264$end
# ir_jmp_gte L4 [L5 . 1] .f1264$end;

 jmp .f1264$body
# ir_jmp .f1264$body;

.f1264$neg:
# ir_make_label .f1264$neg;
...
# ir_load L7 -1;
 ...
 cmp -88(%rbp),%r10d
 jle .f1264$end
# ir_jmp_lte L4 [L5 . 1] .f1264$end;

.f1264$body:
# ir_make_label .f1264$body;
...
# ir_neg 1; (push)
 ...
 cmp %eax,%r10d
 je .if1359$else
# ir_jmp_eq L0 POP() .if1359$else;

.if1359$body:
# ir_make_label .if1359$body;
...
# ir_call cb__Nstd__Nsystem__Nwifexited__Aint L6; (push)
 ...
 cmp $0,%al
 je .if1341$else
# ir_jmp_eq POP() 0 .if1341$else;

.if1341$body:
# ir_make_label .if1341$body;
...
# ir_call cb__Nstd__Nsystem__Nwifsignaled__Aint L6; (push)
 ...
 cmp $0,%al
 je .if1340$else
# ir_jmp_eq POP() 0 .if1340$else;

.if1340$body:
# ir_make_label .if1340$body;
...
.if1340$else:
# ir_make_label .if1340$else;

.if1341$end:
# ir_make_label .if1341$end;
...
.if1359$end:
# ir_make_label .if1359$end;

.if1360$end:
# ir_make_label .if1360$end;
...
# ir_load L2 [L0 . 1];
 ...
 cmp $0,%r10d
 je .if1498$else
# ir_jmp_eq L2 0 .if1498$else;

.if1498$body:
# ir_make_label .if1498$body;
...
# ir_load L5 [L3 . 1];
 ...
 cmp $0,%r10d
 je .if1561$else
# ir_jmp_eq L5 0 .if1561$else;

.if1561$body:
# ir_make_label .if1561$body;
...
.f1652$cond:
# ir_make_label .f1652$cond;

 mov -156(%rbp),%r10d
 cmp -152(%rbp),%r10d
 jge .f1652$neg
# ir_jmp_gte [L11 . 0] [L11 . 1] .f1652$neg;
...
# ir_load L15 1;
 ...
 cmp -152(%rbp),%r10d
 jge .f1652$end
# ir_jmp_gte L10 [L11 . 1] .f1652$end;

 jmp .f1652$body
# ir_jmp .f1652$body;

.f1652$neg:
# ir_make_label .f1652$neg;
...
# ir_load L15 -1;
 ...
 cmp -152(%rbp),%r10d
 jle .f1652$end
# ir_jmp_lte L10 [L11 . 1] .f1652$end;

.f1652$body:
# ir_make_label .f1652$body;
...
.f1679$cond:
# ir_make_label .f1679$cond;

 mov -168(%rbp),%r10d
 cmp -164(%rbp),%r10d
 jge .f1679$neg
# ir_jmp_gte [L13 . 0] [L13 . 1] .f1679$neg;
...
# ir_load L16 1;
 ...
 cmp -164(%rbp),%r10d
 jge .f1679$end
# ir_jmp_gte L12 [L13 . 1] .f1679$end;

 jmp .f1679$body
# ir_jmp .f1679$body;

.f1679$neg:
# ir_make_label .f1679$neg;
...
# ir_load L16 -1;
 ...
 cmp -164(%rbp),%r10d
 jle .f1679$end
# ir_jmp_lte L12 [L13 . 1] .f1679$end;

.f1679$body:
# ir_make_label .f1679$body;
...
# ir_call cb__Nstd__Nlinux__Nsyscall__Nstat__Aptr__Tpure__Tuint8__Aptr__Topaque [POP() . 0] POP(); (push)
 ...
 cmp $0,%eax
 jge .if1902$else
# ir_jmp_gte POP() 0 .if1902$else;

.if1902$body:
# ir_make_label .if1902$body;
...
# ir_call cb__Nstd__Nlinux__Nsyscall__Nfstat__Aint__Aptr__Topaque POP() POP(); (push)
 ...
 cmp $0,%eax
 jge .if1956$else
# ir_jmp_gte POP() 0 .if1956$else;

.if1956$body:
# ir_make_label .if1956$body;
