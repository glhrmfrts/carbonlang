...
.f568$cond:
# ir_make_label .f568$cond;

 mov -48(%rbp),%r10d
 cmp -40(%rbp),%r10d
 jge .f568$neg
# ir_jmp_gte [L2 . 0] [L2 . 1] .f568$neg;
...
# ir_load L5 1;
 ...
 cmp -40(%rbp),%r10d
 jge .f568$end
# ir_jmp_gte L1 [L2 . 1] .f568$end;

 jmp .f568$body
# ir_jmp .f568$body;

.f568$neg:
# ir_make_label .f568$neg;
...
# ir_load L5 -1;
 ...
 cmp -40(%rbp),%r10d
 jle .f568$end
# ir_jmp_lte L1 [L2 . 1] .f568$end;

.f568$body:
# ir_make_label .f568$body;
...
# prolog end
 ...
 cmp $0,%r10d
 jne .if598$else
# ir_jmp_neq A1 0 .if598$else;

.if598$body:
# ir_make_label .if598$body;
...
.w701$cond:
# ir_make_label .w701$cond;

 mov -24(%rbp),%r10
 cmp -16(%rbp),%r10
 jge .w701$end
# ir_jmp_gte L2 L1 .w701$end;

.w701$body:
# ir_make_label .w701$body;
...
# ir_deref L5; (push)
 ...
 cmp 0(%rax),%r10d
 jne .if684$else
# ir_jmp_neq L3 POP() .if684$else;

.if684$body:
# ir_make_label .if684$body;
...
# ir_cast POP(); (push)
 ...
 cmp %rax,%r10
 jne .if1027$else
# ir_jmp_neq L1 POP() .if1027$else;

.if1027$body:
# ir_make_label .if1027$body;
...
# ir_and A0 1; (push)
 ...
 cmp $0,%eax
 je .if1230$else
# ir_jmp_eq POP() 0 .if1230$else;

.if1230$body:
# ir_make_label .if1230$body;
...
# ir_and A0 2; (push)
 ...
 cmp $0,%eax
 je .if1229$else
# ir_jmp_eq POP() 0 .if1229$else;

.if1229$body:
# ir_make_label .if1229$body;
...
.if1229$else:
# ir_make_label .if1229$else;

.if1230$end:
# ir_make_label .if1230$end;

.if1231$end:
# ir_make_label .if1231$end;
...
# ir_and A0 4; (push)
 ...
 cmp $0,%eax
 je .if1241$else
# ir_jmp_eq POP() 0 .if1241$else;

.if1241$body:
# ir_make_label .if1241$body;
...
# ir_and A0 8; (push)
 ...
 cmp $0,%eax
 je .if1251$else
# ir_jmp_eq POP() 0 .if1251$else;

.if1251$body:
# ir_make_label .if1251$body;
...
# ir_and A0 16; (push)
 ...
 cmp $0,%eax
 je .if1261$else
# ir_jmp_eq POP() 0 .if1261$else;

.if1261$body:
# ir_make_label .if1261$body;
...
# ir_load L0 POP();
 ...
 cmp $0,%r10d
 jne .if1539$else
# ir_jmp_neq L0 0 .if1539$else;

.if1539$body:
# ir_make_label .if1539$body;
...
.f1443$cond:
# ir_make_label .f1443$cond;

 mov -96(%rbp),%r10d
 cmp -88(%rbp),%r10d
 jge .f1443$neg
# ir_jmp_gte [L5 . 0] [L5 . 1] .f1443$neg;
...
# ir_load L7 1;
 ...
 cmp -88(%rbp),%r10d
 jge .f1443$end
# ir_jmp_gte L4 [L5 . 1] .f1443$end;

 jmp .f1443$body
# ir_jmp .f1443$body;

.f1443$neg:
# ir_make_label .f1443$neg;
...
# ir_load L7 -1;
 ...
 cmp -88(%rbp),%r10d
 jle .f1443$end
# ir_jmp_lte L4 [L5 . 1] .f1443$end;

.f1443$body:
# ir_make_label .f1443$body;
...
# ir_neg 1; (push)
 ...
 cmp %eax,%r10d
 je .if1538$else
# ir_jmp_eq L0 POP() .if1538$else;

.if1538$body:
# ir_make_label .if1538$body;
...
# ir_call cb__Nstd__Nsystem__Nwifexited__Aint L6; (push)
 ...
 cmp $0,%al
 je .if1520$else
# ir_jmp_eq POP() 0 .if1520$else;

.if1520$body:
# ir_make_label .if1520$body;
...
# ir_call cb__Nstd__Nsystem__Nwifsignaled__Aint L6; (push)
 ...
 cmp $0,%al
 je .if1519$else
# ir_jmp_eq POP() 0 .if1519$else;

.if1519$body:
# ir_make_label .if1519$body;
...
.if1519$else:
# ir_make_label .if1519$else;

.if1520$end:
# ir_make_label .if1520$end;
...
.if1538$end:
# ir_make_label .if1538$end;

.if1539$end:
# ir_make_label .if1539$end;
...
# ir_load L2 [L0 . 1];
 ...
 cmp $0,%r10d
 je .if1677$else
# ir_jmp_eq L2 0 .if1677$else;

.if1677$body:
# ir_make_label .if1677$body;
...
# ir_load L5 [L3 . 1];
 ...
 cmp $0,%r10d
 je .if1740$else
# ir_jmp_eq L5 0 .if1740$else;

.if1740$body:
# ir_make_label .if1740$body;
...
.f1831$cond:
# ir_make_label .f1831$cond;

 mov -156(%rbp),%r10d
 cmp -152(%rbp),%r10d
 jge .f1831$neg
# ir_jmp_gte [L11 . 0] [L11 . 1] .f1831$neg;
...
# ir_load L15 1;
 ...
 cmp -152(%rbp),%r10d
 jge .f1831$end
# ir_jmp_gte L10 [L11 . 1] .f1831$end;

 jmp .f1831$body
# ir_jmp .f1831$body;

.f1831$neg:
# ir_make_label .f1831$neg;
...
# ir_load L15 -1;
 ...
 cmp -152(%rbp),%r10d
 jle .f1831$end
# ir_jmp_lte L10 [L11 . 1] .f1831$end;

.f1831$body:
# ir_make_label .f1831$body;
...
.f1858$cond:
# ir_make_label .f1858$cond;

 mov -168(%rbp),%r10d
 cmp -164(%rbp),%r10d
 jge .f1858$neg
# ir_jmp_gte [L13 . 0] [L13 . 1] .f1858$neg;
...
# ir_load L16 1;
 ...
 cmp -164(%rbp),%r10d
 jge .f1858$end
# ir_jmp_gte L12 [L13 . 1] .f1858$end;

 jmp .f1858$body
# ir_jmp .f1858$body;

.f1858$neg:
# ir_make_label .f1858$neg;
...
# ir_load L16 -1;
 ...
 cmp -164(%rbp),%r10d
 jle .f1858$end
# ir_jmp_lte L12 [L13 . 1] .f1858$end;

.f1858$body:
# ir_make_label .f1858$body;
...
# ir_call cb__Nstd__Nlinux__Nsyscall__Nstat__Aptr__Tpure__Tuint8__Aptr__Topaque [POP() . 0] POP(); (push)
 ...
 cmp $0,%eax
 jge .if2081$else
# ir_jmp_gte POP() 0 .if2081$else;

.if2081$body:
# ir_make_label .if2081$body;
...
# ir_call cb__Nstd__Nlinux__Nsyscall__Nfstat__Aint__Aptr__Topaque POP() POP(); (push)
 ...
 cmp $0,%eax
 jge .if2135$else
# ir_jmp_gte POP() 0 .if2135$else;

.if2135$body:
# ir_make_label .if2135$body;
