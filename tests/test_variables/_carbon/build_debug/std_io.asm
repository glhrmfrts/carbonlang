...
# prolog end
 ...
 mov 16(%rbp),%r10b
 cmp $0,%r10b
 je cb__Nstd__Nio__Nprint__Abool$if139$else
# ir_jmp_eq A0 0 cb__Nstd__Nio__Nprint__Abool$if139$else;

cb__Nstd__Nio__Nprint__Abool$if139$body:
# ir_make_label cb__Nstd__Nio__Nprint__Abool$if139$body;
...
# ir_call cb__Nstd__Nio__Nprint__Aptr__Tslice__Tpure__Tuint8 POP();
 ...
 jmp cb__Nstd__Nio__Nprint__Abool$if139$end
# ir_jmp cb__Nstd__Nio__Nprint__Abool$if139$end;

cb__Nstd__Nio__Nprint__Abool$if139$else:
# ir_make_label cb__Nstd__Nio__Nprint__Abool$if139$else;
...
cb__Nstd__Nio__Nprint__Abool$if139$end:
# ir_make_label cb__Nstd__Nio__Nprint__Abool$if139$end;
